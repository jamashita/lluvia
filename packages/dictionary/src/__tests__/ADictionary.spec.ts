...
describe('AProject', () => {
  describe('contains', () => {
    it('returns false if the value does not exist', () => {
      ...
      const project: MockDictionary<MockValueObject<number>, MockValueObject<number>> = new MockDictionary(
        new Map([[key1, value1]])
      );
  ...
  describe('equals', () => {
    ...
    it('returns false if the size is different', () => {
      ...
      const project1: MockDictionary<MockValueObject<number>, MockValueObject<number>> = new MockDictionary(
        new Map([[key1, value1]])
      );
      const project2: MockDictionary<MockValueObject<number>, MockValueObject<number>> = new MockDictionary(
        new Map([
          [key1, value1],
          [key2, value2]
        ])
    ...
    it('returns false when the different class instance given', () => {
      const project: MockDictionary<MockValueObject<number>, MockValueObject<number>> = new MockDictionary<MockValueObject<number>, MockValueObject<number>>(
        new Map()
      );
  ...
  describe('every', () => {
    ...
    it('if one of them are not satisfied, returns false', () => {
      ...
      const project3: MockDictionary<MockValueObject<number>, MockValueObject<number>> = new MockDictionary(
        new Map([
          [key1, value2],
          [key2, value3],
          [key3, value1],
      ...
      const project4: MockDictionary<MockValueObject<number>, MockValueObject<number>> = new MockDictionary(
        new Map([
          [key1, value2],
          [key2, value3],
          [key3, value4],
      ...
      const project5: MockDictionary<MockValueObject<number>, MockValueObject<number>> = new MockDictionary(
        new Map([
          [key1, value1],
          [key2, value5],
          [key3, value3],
      ...
      const project6: MockDictionary<MockValueObject<number>, MockValueObject<number>> = new MockDictionary(
        new Map([
          [key1, value1],
          [key2, value2],
          [key3, value5],
  ...
  describe('find', () => {
    it('returns the first found value', () => {
      ...
      const project: MockDictionary<MockValueObject<string>, MockValueObject<number>> = new MockDictionary(new Map([
        [key1, value1],
        [key2, value2],
        [key3, value3],
        [key4, value4]
  ...
  describe('isEmpty', () => {
    it('returns true if the values does not exist', () => {
      ...
      const project2: MockDictionary<MockValueObject<number>, MockValueObject<number>> = new MockDictionary<MockValueObject<number>, MockValueObject<number>>(
        new Map()
      );
  ...
  describe('iterator', () => {
    it('returns [MockValueObject<string>, MockValueObject<number>]', () => {
      ...
      const project: MockDictionary<MockValueObject<string>, MockValueObject<number>> = new MockDictionary(
        new Map([
          [key1, value1],
          [key2, value2]
        ])
